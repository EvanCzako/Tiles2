...
// Combo multiplier color ramp: grey → yellow → orange → red-orange → red.
// Index by min(combo, 5) - 1. Shared by the combo badge and score popups.
export const COMBO_COLORS = ['#8888aa', '#ffcc00', '#ff8822', '#ff4422', '#dd1144'];
